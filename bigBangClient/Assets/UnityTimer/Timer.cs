...
namespace UnityTimer
{
    public class Timer
    {
        ...
        /// <summary>
        /// 尽量用这个，当bindGameObject销毁后，timer也会销毁
        ...
        public static Timer Register(GameObject bindGameObject, float duration, Action onComplete, Action<float> onUpdate = null,
            bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
        {
            ...
            timer.AddTo(bindGameObject);
            return timer;
        }

        /// <summary>
        /// 不绑定GameObject，timer不会因bindGameObject销毁而销毁
        /// </summary>
        public static Timer RegisterWithNoBindGameObject(float duration, Action onComplete, Action<float> onUpdate = null,
            bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
        {
            return Register(null, duration, onComplete, onUpdate, isLooped, useRealTime, autoDestroyOwner);
        }
        ...
        private void Update()
        {
            ...
            if (this.GetWorldTime() >= this.GetFireTime())
            {
                ...
                if (this._onComplete != null)
                {
                    ...
                    {
                        UnityEngine.Debug.LogWarning("UnityTimer , Timer , Update , Exception thrown in OnComplete callback. \n" + e.ToString());
                    }
                }
