...
public class DragonYearTaskPad : MonoBehaviour, IActivity
{
    ...
    private void RefreshTaskList()
    {
        ...
        {
            Debug.LogWarning("DragonYearTaskPad , RefreshTaskList ,  festivalTaskInfoList.Count <= 0 , activityData.cfg.Id = " + activityData.cfg.Id);
        }
