...
{
    public class DragonBoatFestivalSignSelectUIProperties : WindowProperties
    {
        public NewYearSignItem newYearSignItem;
        public DragonBoatFestivalSignSelectUIProperties(NewYearSignItem newYearSignItem)
        {
            this.newYearSignItem = newYearSignItem;
        }
    }
    public class DragonBoatFestivalSignSelectUI : AWindowController<DragonBoatFestivalSignSelectUIProperties>
    {
        ...
        private void OnClose()
        {
            ...
            UIController.Instance.CloseWindow<DragonBoatFestivalSignSelectUI>();
        }
        protected override void OnPropertiesSet()
        {
            base.OnPropertiesSet();

            Debug.Log("DragonBoatFestivalSignSelectUI , OnPropertiesSet , Properties.newYearSignItem.itemIndex = " + Properties.newYearSignItem.itemIndex);
