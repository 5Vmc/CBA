...
{
    public class LabourDaySignPad : MonoBehaviour, IActivity
    {
        #region 初始化
        ...
        {
            UIController.Instance.OpenWindow<LabourDaySignHelpUI>();
        }
        ...
        private void RefreshActivityData()
        {
            ...
            {
                Debug.LogError("LabourDaySignPad , RefreshActivityData , wishSignConfig == null , activityData.cfg.Id = {0}".SafeFormat(activityData.cfg.Id));
