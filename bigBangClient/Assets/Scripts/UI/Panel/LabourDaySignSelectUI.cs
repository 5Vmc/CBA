...
{
    public class LabourDaySignSelectUIProperties : WindowProperties
    {
        public NewYearSignItem newYearSignItem;
        public LabourDaySignSelectUIProperties(NewYearSignItem newYearSignItem)
        {
            this.newYearSignItem = newYearSignItem;
        }
    }
    public class LabourDaySignSelectUI : AWindowController<LabourDaySignSelectUIProperties>
    {
        ...
        private void OnClose()
        {
            ...
            UIController.Instance.CloseWindow<LabourDaySignSelectUI>();
        }
        protected override void OnPropertiesSet()
        {
            base.OnPropertiesSet();

            Debug.Log("LabourDaySignSelectUI , OnPropertiesSet , Properties.newYearSignItem.itemIndex = " + Properties.newYearSignItem.itemIndex);
