...
{
    public class DragonYearSignSelectUIProperties : WindowProperties
    {
        public NewYearSignItem newYearSignItem;
        public DragonYearSignSelectUIProperties(NewYearSignItem newYearSignItem)
        {
            this.newYearSignItem = newYearSignItem;
        }
    }
    public class DragonYearSignSelectUI : AWindowController<DragonYearSignSelectUIProperties>
    {
        ...
        private void OnClickStartButton(BabuButton button)
        {
            UIController.Instance.OpenWindow<ConfirmationBoxUI>(new ConfirmationBoxUIProperties("奖励选择后不可更改，是否确定？", () =>
            {
                NetworkManager.Instance.SetWishSign(Properties.newYearSignItem.activityData.cfg.Id, selectItenIndex, (SetWishSignResponse setWishSignResponse) =>
                {
                    ...
                    ActivityController.Instance.RefreshRedDot(Properties.newYearSignItem.activityData);
        ...
        private void OnClose()
        {
            ...
            UIController.Instance.CloseWindow<DragonYearSignSelectUI>();
        }
        protected override void OnPropertiesSet()
        {
            base.OnPropertiesSet();

            Debug.Log("DragonYearSignSelectUI , OnPropertiesSet , Properties.newYearSignItem.itemIndex = " + Properties.newYearSignItem.itemIndex);
