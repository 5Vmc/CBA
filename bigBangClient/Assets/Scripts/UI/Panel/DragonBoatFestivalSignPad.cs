...
{
    public class DragonBoatFestivalSignPad : MonoBehaviour, IActivity
    {
        #region 初始化
        ...
        {
            UIController.Instance.OpenWindow<DragonBoatFestivalSignHelpUI>();
        }
        ...
        private void RefreshActivityData()
        {
            ...
            {
                Debug.LogError("DragonBoatFestivalSignPad , RefreshActivityData , wishSignConfig == null , activityData.cfg.Id = {0}".SafeFormat(activityData.cfg.Id));
