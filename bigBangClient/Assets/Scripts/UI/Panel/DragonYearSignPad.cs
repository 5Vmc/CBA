...
{
    public class DragonYearSignPad : MonoBehaviour, IActivity
    {
        #region 初始化
        ...
        {
            UIController.Instance.OpenWindow<DragonYearSignHelpUI>();
        }
        ...
        private void RefreshActivityData()
        {
            ...
            {
                Debug.LogError("DragonYearSignUI , RefreshActivityData , wishSignConfig == null , activityData.cfg.Id = {0}".SafeFormat(activityData.cfg.Id));
