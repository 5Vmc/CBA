...
{
    public class Olympics2024SignSelectUIProperties : WindowProperties
    {
        public NewYearSignItem newYearSignItem;
        public Olympics2024SignSelectUIProperties(NewYearSignItem newYearSignItem)
        {
            this.newYearSignItem = newYearSignItem;
        }
    }
    public class Olympics2024SignSelectUI : AWindowController<Olympics2024SignSelectUIProperties>
    {
        ...
        private void OnClose()
        {
            ...
            UIController.Instance.CloseWindow<Olympics2024SignSelectUI>();
        }
        protected override void OnPropertiesSet()
        {
            base.OnPropertiesSet();

            Debug.Log("Olympics2024SignSelectUI , OnPropertiesSet , Properties.newYearSignItem.itemIndex = " + Properties.newYearSignItem.itemIndex);
