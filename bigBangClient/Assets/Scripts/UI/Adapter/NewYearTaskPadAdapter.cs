...
{
    public class NewYearTaskPadAdapter : OSA<NewYearTaskPadParams, NewYearTaskPadHolder>
    {
        ...
        protected override void UpdateViewsHolder(NewYearTaskPadHolder newOrRecycled)
        {
            var model = Data[newOrRecycled.ItemIndex];
            newOrRecycled.UpdateViews(model);
        }
#if UNITY_WEBGL
        protected override bool IsRecyclable(NewYearTaskPadHolder potentiallyRecyclable, int indexOfItemThatWillBecomeVisible, double sizeOfItemThatWillBecomeVisible)
        {
        ...
        protected override NewYearTaskPadHolder CreateViewsHolder(int itemIndex)
        {
            var instance = new NewYearTaskPadHolder();
    ...
    [Serializable]
    public class NewYearTaskPadParams : BaseParams
    {
        public GameObject prefab;
    }

    public class NewYearTaskPadHolder : BaseItemViewsHolder
    {
        public NewYearTaskItem item;

        public override void CollectViews()
        {
            base.CollectViews();
            item = root.GetComponent<NewYearTaskItem>();
        }
