...
{
    public class HundredGuessSupportAdapter : OSA<HundredGuessSupportParams, HundredGuessSupportHolder>
    {
        ...
        protected override void UpdateViewsHolder(HundredGuessSupportHolder newOrRecycled)
        {
            var model = Data[newOrRecycled.ItemIndex];
            newOrRecycled.UpdateViews(model);
        }
#if UNITY_WEBGL
        protected override bool IsRecyclable(HundredGuessSupportHolder potentiallyRecyclable, int indexOfItemThatWillBecomeVisible, double sizeOfItemThatWillBecomeVisible)
        {
        ...
        protected override HundredGuessSupportHolder CreateViewsHolder(int itemIndex)
        {
            var instance = new HundredGuessSupportHolder();
    ...
    [Serializable]
    public class HundredGuessSupportParams : BaseParams
    {
        public GameObject prefab;
    }

    public class HundredGuessSupportHolder : BaseItemViewsHolder
    {
        public HundredGuessSupportItem item;
        public AdapterItemAnim anim;

        public override void CollectViews()
        {
            base.CollectViews();
            item = root.GetComponent<HundredGuessSupportItem>();
