...
public class DragonBoatFestivalHomeTaskItem : MonoBehaviour
{
    [SerializeField] private RectTransform dragonBoatFestivalHomeTaskItem = null;
    ...
    private void RefreshDataNormal()
    {
        ...
        {
            Debug.LogError("DragonBoatFestivalHomeTaskItem , SetData , festivalTaskInfo == null");
            return;
        }
        this.festivalTaskConfig = Configs.FestivalTask.GetConfig(festivalTaskInfo.Id);
        if (festivalTaskConfig == null)
        {
            Debug.LogError("DragonBoatFestivalHomeTaskItem , SetData , festivalTaskConfig == null , festivalTaskInfo.Id = {0} , festivalTaskInfo.Id = {1}".SafeFormat(festivalTaskInfo.Id, festivalTaskInfo.Id));
            return;
        }
        ...
        {
            Debug.LogError("DragonBoatFestivalHomeTaskItem , SetData , gameItemList.Count == 0 , festivalTaskInfo.Id = {0} , festivalTaskInfo.Id = {1} , festivalTaskConfig.Reward = {2}".SafeFormat(festivalTaskInfo.Id, festivalTaskInfo.Id, festivalTaskConfig.Reward));
            return;
        }
